...
class MongoDB:
    ...
    def get_collection_name(self, tld: str) -> str:
        ...
        # Sanitize TLD name for collection name
    ...
    async def list_tld_collections(self) -> List[str]:
        ...
        # Filter only TLD collections (ending with _tld)
    ...
    async def get_all_tlds(self) -> List[str]:
        ...
        # Extract TLD name from collection name (remove _tld suffix)
